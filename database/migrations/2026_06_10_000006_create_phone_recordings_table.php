...
return new class extends Migration
{
    ...
    {
        Schema::create('phone_recordings', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['provider', 'provider_recording_sid'], 'phone_recordings_provider_sid_unique');
            $table->index(['phone_call_id', 'created_at'], 'phone_recordings_call_created_index');
            $table->index(['purpose', 'status'], 'phone_recordings_purpose_status_index');
        });
    }
